...
// Then we create a true, exact match only conditional to assess if name = Mary
// The conditional is not true so we log "how do you do"
//
...
//Create a variable called secret.  Create a variable called code and set it to 123.
//create an exact match only conditional to see if "code" is equal to 123.  Since it is,
//secret will be set to 'super' and code will be set to (123 * 2)= 246.  246 is not greater
//than 250 so the log(secret) will display as 'super'.  I think..... :)
